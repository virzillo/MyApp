...
<div class="modal fade show" id="crea-customer" tabindex="-1" role="dialog" aria-labelledby="crea-utenteLabel" style="display:none;">
...
<select name="company_id" id="company_id" class="form-control">
                          ...
                          <div class="col-lg-3">
 <a href="#" data-toggle="modal" data-target="#crea-company" class="btn waves-effect waves-light btn-rounded btn-primary justify-content-end"> <i class="ti-plus text" aria-hidden="true"></i></a>
...
<div class="modal fade bs-example-modal-sm"  id="crea-company" tabindex="-1" role="dialog" aria-labelledby="companyLabel" style="display: none;" aria-hidden="true">
